...
## 4.1 Make an sf with 150 m buffer -----
...
## 4.2 Get the lu attributes -----
covs_lu <- st_intersection(covs_buff, lu)

## 4.3 Get the BADR treatment proportions ----
set.seed(1234)
covs_test <- covs_lu |> 
# sample_n(10) |> 
...
save(covs_test, bird_test, file=file.path(rootout, "Deviation From Expected", "Data", "Test.Rdata"))
